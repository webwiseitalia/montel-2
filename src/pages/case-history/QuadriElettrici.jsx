...
export default function CaseHistoryQuadri() {
  ...
  const articles = [
    { title: 'Quadri elettrici', path: '/case-history/quadri-elettrici/quadri-elettrici', description: '[Descrizione placeholder]' },
  ]
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="[Intro case history quadri placeholder]"
        breadcrumbs={[

  ...
  const articles = [
    {
      ...
      description: '[Descrizione breve placeholder]'
    },
  ]
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="[Intro case history sensori placeholder]"
        breadcrumbs={[
              ...
              <div className="space-y-6">
                {articles.map((article, index) => (
                  <Link
                    key={index}
                    to={article.path}
                    className="group flex gap-6 bg-white/[0.02] border border-white/10 hover:border-white/30 transition-all"
                  >
                    <div className="w-48 aspect-video bg-white/5 flex-shrink-0 flex items-center justify-center">
